...
export async function seedProjects(dataSource: DataSource): Promise<void> {
  ...
  // Base URL for images
  const baseImageUrl = 'https://rawcdn.githack.com/Giga-Group/The-Giga-Mall-Media/refs/heads/main';
  ...
  const ongoingProjects: Partial<Project>[] = [
    {
      ...
      images: [`${baseImageUrl}/projects/gcv.webp`],
      isCompleted: false,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/gcc.webp`],
      isCompleted: false,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/gme.webp`],
      isCompleted: false,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/gbc-grid.webp`],
      isCompleted: false,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/cpr-grid.webp`],
      isCompleted: false,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/wtc-grid.webp`],
      isCompleted: false,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/gc-highlife-grid-1.webp`],
      isCompleted: false,
    ...
    },
    {
      ...
      description: 'Modern Residential Living',
      images: [`${baseImageUrl}/projects/gc-highlife-grid-2-3.webp`],
      isCompleted: false,
  ...
  const completedProjects: Partial<Project>[] = [
    {
      ...
      images: [`${baseImageUrl}/projects/delivered-projects/gc-views-1-dubai.webp`],
      isCompleted: true,
      linkUrl: 'https://www.gigagroup.com/project-single/9',
    },
    {
      ...
      images: [`${baseImageUrl}/projects/delivered-projects/gc-views-2-dubai.webp`],
      isCompleted: true,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/delivered-projects/gcv-exective-dubai.webp`],
      isCompleted: true,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/delivered-projects/canyon-views.webp`],
      isCompleted: true,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/delivered-projects/cresent-bay.webp`],
      isCompleted: true,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/delivered-projects/defence-resedency.webp`],
      isCompleted: true,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/delivered-projects/giga-boutique-mall.webp`],
      isCompleted: true,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/delivered-projects/elcielo-1-and-2.webp`],
      isCompleted: true,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/delivered-projects/lignum-tower.webp`],
      isCompleted: true,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/delivered-projects/giga-mall.webp`],
      isCompleted: true,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/delivered-projects/pearl-residency.webp`],
      isCompleted: true,
    ...
    },  
    {
      ...
      images: [`${baseImageUrl}/projects/delivered-projects/al-najeebi-bazaar.webp`],
      isCompleted: true,
    ...
    },
    {
      ...
      images: [`${baseImageUrl}/projects/delivered-projects/gc-souq-lahore.webp`],
      isCompleted: true,
