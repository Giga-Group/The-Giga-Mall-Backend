...
export async function seedFeatured(
  ...
  const samples: Partial<FeaturedItem>[] = [
    {
      image: 'https://rawcdn.githack.com/Giga-Group/The-Giga-Mall-Media/refs/heads/main/Featured/Projects/p5.webp',
      name: 'GoldCrest View',
      description: 'Luxury Lifestyle Premium Location',
      url: 'https://www.gigagroup.com/project-single/1',
    },
    {
      image: 'https://rawcdn.githack.com/Giga-Group/The-Giga-Mall-Media/refs/heads/main/Featured/Projects/p3.webp',
      name: 'Goldcrest View',
      description: 'Luxury Lifestyle Premium Location',
      url: 'https://www.gigagroup.com/project-single/1',
    },
    {
      image: 'https://rawcdn.githack.com/Giga-Group/The-Giga-Mall-Media/refs/heads/main/Featured/Projects/p6.webp',
      name: 'GoldCrest View',
      description: 'Luxury Lifestyle Premium Location',
      url: 'https://www.gigagroup.com/project-single/1',
    },
    {
      image: 'https://rawcdn.githack.com/Giga-Group/The-Giga-Mall-Media/refs/heads/main/Featured/Projects/p11.webp',
      name: 'GoldCrest View',
      description: 'Luxury Lifestyle Premium Location',
      url: 'https://www.gigagroup.com/project-single/1',
    },
